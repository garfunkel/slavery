...
#define ACTION_MAP(ACTION)                                       \
	...
	ACTION_UNKNOWN(SLAVERY_CONFIG_ACTION_UNKNOWN, "unknown")

typedef enum
{
#define ACTION(action_id, action_string) action_id,
#define ACTION_UNKNOWN(action_id, action_string) action_id
	ACTION_MAP(ACTION)
#undef ACTION
#undef ACTION_UNKNOWN
...
#define ACTION_UNKNOWN(action_id, action_string) \
	default:                                     \
		return action_string;
		ACTION_MAP(ACTION)
#undef ACTION
...
#define ACTION_UNKNOWN(action_id, action_string) return action_id;
	ACTION_MAP(ACTION)
#undef ACTION
#undef ACTION_UNKNOWN
#undef ACTION_MAP
